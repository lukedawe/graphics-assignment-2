...
// per vertex lighting
// Added fog in vertex shader (not a good solution, better in fragment shader)
...
uniform uint colourmode, emitmode, fogmode;
...
void main()
{
	...
	// Output the distance to the vertex in view space
	// This is used as depth to calculate fog density
