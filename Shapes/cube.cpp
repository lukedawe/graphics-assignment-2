...
void Cube::makeCube(glm::vec3 colour)
{
	...
	// takes a vec 3 of colours and puts them on all sides of the cube
	// this cannot be used if you want multiple colours on each side of the cube
	float vertexColours[] = {
